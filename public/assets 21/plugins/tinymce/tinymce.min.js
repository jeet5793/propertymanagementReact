...
! function (e, t) {
	...
	r(l, [], function () {
		...
		var C, x, w, N, E, _, S, k, T, R, A, B, D, L, M, P, H, O, I, F = "sizzle" + -new Date,
			z = window.document,
			U = 0,
			W = 0,
			V = n(),
		...
		function i(i, a) {
			...
			i = i || {}, l.schema = a = a || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), o("comment cdata text start end pi doctype".split(" "), function (e) {
				...
				var l = this,
					c, u = 0,
					d, f, h = [],
					p, m, g, v, y, b, C, x, w, N, E, _, S, k, T, R, A, B, D, L, M, P, H, O, I, F = 0,
					z = t.decode,
		...
		return function (i, s) {
			...
			function d(e, t, n) {
				var i, o, a, d, h;
				f(), x(), i = _.getPos(e, X), P = i.x, H = i.y, h = e.getBoundingClientRect(), o = h.width || h.right - h.left, a = h.height || h.bottom - h.top, k != e && (C(), k = e, U = W = 0), d = s.fire("ObjectSelected", {
					target: e
			...
			var _ = s.dom,
				S = t.each,
				k, T, R, A, B, D, L, M, P, H, O, I, F, z, U, W, V = s.getDoc(),
				$ = document,
				q = r.ie && r.ie < 11,
				j = Math.abs,
				Y = Math.round,
			...
			function o(o) {
				...
				if (R = s.getRng(!0), !o.isDefaultPrevented()) {
					...
					if (new t(a).normalize(R), D = R.startContainer, L = R.startOffset, W = (l.force_p_newlines ? "p" : "") || l.forced_root_block, W = W ? W.toUpperCase() : "", P = a.doc.documentMode, H = o.shiftKey, 1 == D.nodeType && D.hasChildNodes() && (V = L > D.childNodes.length - 1, D = D.childNodes[Math.min(L, D.childNodes.length - 1)] || D, L = V && 3 == D.nodeType ? D.nodeValue.length : 0), B = S(D)) {
						...
						W && M === i.getBody() || (W = W || "P", x() ? T() : x(!0) ? (O = M.parentNode.insertBefore(C(), M), m(O), v(M)) : (A = R.cloneRange(), A.setEndAfter(M), I = A.extractContents(), _(I), O = I.firstChild, a.insertAfter(I, M), g(O), k(M), a.isEmpty(M) && b(M), O.normalize(), a.isEmpty(O) ? (a.remove(O), T()) : v(O)), a.setAttrib(O, "id", ""), i.fire("NewBlock", {
							newBlock: O
						}), c.add())
					}
				}
		...
		return e.extend({
			recalc: function (e) {
				var t, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v = [],
					y, b, C, x, w, N, E, _, S, k, T, R, A, B, D, L, M, P, H, O, I, F, z = Math.max,
					U = Math.min;
