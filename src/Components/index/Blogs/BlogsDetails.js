								...
								<div className="col-lg-9 col-md-8 col-sm-8 col-xs-12 tz-has-sidebar">
									<div id='post-523' className="tz-post-item">
										...
										<div className="tz-post-content">
											<div className="tz-post-thumbbox tz-post-thumbnail blog-detl-img"> 
											<img onError={this.addDefaultSrc} src={`${API_URL}assetsadmin/`+blogData.img_path} className="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""   />
											</div>
											<div className="tz-post-excerpt blog-detl-pra" dangerouslySetInnerHTML={{__html: blogData.description}} />
