...
import BrokerInitiatePropertyContract from '../../../images/helpImage/agent-initiate-property-contract.png'
import AgentTenantBgv from '../../../images/helpImage/agent-tenant-bgv.png'
import MerchantAgent from '../../../images/helpImage/merchant-agent.png'
                        ...
                        <div className="col-md-12 no-padding lib-item" data-category="view">
                            <div className="lib-panel">
                                ...
                                <div className="box-shadow">
                                    ...
                                    <div className="col-md-12">
                                        <img className="lib-img-show helpImg" src={BrokerInitiatePropertyContract}/>
                                    </div>
                                ...
                                <div className="box-shadow">
                                    ...
                                    <div className="col-md-12">
                                        <img className="lib-img-show helpImg" src={MerchantAgent}/>
                                    </div>
                                ...
                                <div className="box-shadow">
                                    ...
                                    <div className="col-md-12">
                                        <img className="lib-img-show helpImg" src={AgentTenantBgv}/>
                                    </div>
                                ...
                                <div className="box-shadow">
                                    ...
                                    <div className="col-md-12">
                                        <div className="lib-row lib-header">
                                            <h4 className="helpHeading">Send Message to Owner/Tenant</h4>
                                            <div className="lib-header-seperator"></div>
                                        </div>
                                    </div>	
                                    
                                    <div className="col-md-12">
                                        <img className="lib-img-show helpImg" src={SendSmsAgentOwner}/>
                                        <img className="lib-img-show helpImg" src={SendSmsAgentTenant}/>
                                    </div>
