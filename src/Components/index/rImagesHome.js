...
export default class RIMages extends React.Component{
	...
	render(){
		return(
			<div id="tz-pro-slider-5ac1cdf22e330" style={{visibility:'block'}} className="cbp cbp-l-grid-team tz-property-slider false">
				                            <div className="tz-property-content cbp-item  slider ">
				                              <div className="tz-property-thum cbp-caption">
				                                <div className="cbp-caption-defaultWrap">
				                                  <figure> <img src={img3} alt="Assets Watch" width="900" height="328" />
				                                ...
				                                <div className="cbp-caption-activeWrap">
				                                  <div className="cbp-l-caption-alignCenter">
				                                    ...
				                                    <a href={img4} className="cbp-lightbox cbp-l-caption-buttonRight" data-title="Stylish Apartment"> 
				                            ...
				                            <div className="tz-property-content cbp-item  slider ">
				                              <div className="tz-property-thum cbp-caption">
				                                <div className="cbp-caption-defaultWrap">
				                                  <figure> <img src={img5} alt="Assets Watch" width="900" height="328" />
				                                ...
				                                <div className="cbp-caption-activeWrap">
				                                  <div className="cbp-l-caption-alignCenter">
				                                    <div className="cbp-l-caption-body"> <a href="" className="cbp-l-caption-buttonLeft" rel="nofollow"> 
				                                      <i className="icon-link"></i> </a> <a href={img6} className="cbp-lightbox cbp-l-caption-buttonRight" data-title="Sophisticated Residence"> 
				                                      <i className="icon-plus-circle"></i> </a> </div>
				                                  </div>
				                                </div>
				                              </div>
				                            ...
				                            <div className="tz-property-content cbp-item  slider ">
				                              <div className="tz-property-thum cbp-caption">
				                                <div className="cbp-caption-defaultWrap">
				                                  <figure> <img src={img7} alt="Assets Watch" width="900" height="328" />
				                                    <figcaption className="for-sale for-rent"> FOR RENT </figcaption>
				                                  </figure>
				                                </div>
				                                <div className="cbp-caption-activeWrap">
				                                  <div className="cbp-l-caption-alignCenter">
				                                    <div className="cbp-l-caption-body"> 
				                                    	<a href="" className="cbp-l-caption-buttonLeft" rel="nofollow"> <i className="icon-link"></i> </a> 
				                                    	<a href={img8} className="cbp-lightbox cbp-l-caption-buttonRight" data-title="Luxury Mansion"> <i className="icon-plus-circle"></i> </a> </div>
				                                  </div>
				                                </div>
				                              </div>
				                              <div className="tz-property-des">
				                            ...
				                            <div className="tz-property-content cbp-item  slider ">
				                              <div className="tz-property-thum cbp-caption">
				                                <div className="cbp-caption-defaultWrap">
				                                  <figure> <img src={img9} alt="Assets Watch" width="900" height="328" />
				                                ...
				                                <div className="cbp-caption-activeWrap">
				                                  <div className="cbp-l-caption-alignCenter">
				                                    <div className="cbp-l-caption-body"> <a href="" className="cbp-l-caption-buttonLeft" rel="nofollow"> 
				                                      <i className="icon-link"></i> </a> <a href={img9} className="cbp-lightbox cbp-l-caption-buttonRight" data-title="Elegant Apartment"> 
				                                      <i className="icon-plus-circle"></i> </a> </div>
				                                  </div>
				                                </div>
				                              </div>
				                            ...
				                            <div className="tz-property-content cbp-item  slider ">
				                              <div className="tz-property-thum cbp-caption">
				                                <div className="cbp-caption-defaultWrap">
				                                  <figure> 
				                                  <img src={img10} alt="Assets Watch" width="900" height="600" />
				                                    <figcaption className="for-sale "> FOR SALE </figcaption>
				                                  </figure>
				                                </div>
				                                <div className="cbp-caption-activeWrap">
				                                  <div className="cbp-l-caption-alignCenter">
				                                    <div className="cbp-l-caption-body"> <a href="" className="cbp-l-caption-buttonLeft" rel="nofollow"> 
				                                      <i className="icon-link"></i> </a> <a href={img10} className="cbp-lightbox cbp-l-caption-buttonRight" data-title="Joint Tenancy"> 
				                                      <i className="icon-plus-circle"></i> </a> </div>
				                                  </div>
				                                </div>
				                              </div>
				                            ...
				                            <div className="tz-property-content cbp-item  slider ">
				                              <div className="tz-property-thum cbp-caption">
				                                <div className="cbp-caption-defaultWrap">
				                                  <figure> <img src={img11} alt="Assets Watch" width="900" height="598" />
				                                    <figcaption className="for-sale rented"> RENTED </figcaption>
				                                  </figure>
				                                </div>
				                                <div className="cbp-caption-activeWrap">
				                                  <div className="cbp-l-caption-alignCenter">
				                                    <div className="cbp-l-caption-body"> <a href="" className="cbp-l-caption-buttonLeft" rel="nofollow"> 
				                                      <i className="icon-link"></i> </a> <a href={img11} className="cbp-lightbox cbp-l-caption-buttonRight" data-title="Stylish Apartment"> 
				                                      <i className="icon-plus-circle"></i> </a> </div>
				                                  </div>
				                                </div>
				                              </div>
