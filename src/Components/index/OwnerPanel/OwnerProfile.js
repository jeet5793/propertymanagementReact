                ...
                <ul className="list-inline float-right mb-0">
                  ...
                  <li className="list-inline-item dropdown notification-list">
                    ...
                    >
                      ...
                      <span className="badge badge-pink noti-icon-badge">
                        4
                      </span>{" "}
                    </a>
                    <div
                    ...
                    >
                      ...
                      >
                        ...
                        <p className="notify-details">
                          Robert S. Taylor commented on Admin<small className="text-muted">
                            1 min ago
                          </small>
                        </p>
                      </a>
                      ...
                      >
                        ...
                        <p className="notify-details">
                          New user registered.<small className="text-muted">
                            1 min ago
                          </small>
                        </p>
                      </a>
                  ...
                  <li className="list-inline-item dropdown notification-list">
                    ...
                    >
                      ...
                      >
                        {" "}
                        <i className="dripicons-user" /> <span>Profile</span>{" "}
                      </a>
                      {/* item*/}
                      <a
                        href="javascript:void(0);"
                      ...
                      >
                        {" "}
                        <i className="dripicons-gear" /> <span>Settings</span>{" "}
                      </a>
                      {/* item*/}
                      <a
                        href="javascript:void(0);"
                      ...
                      >
                        {" "}
                        <i className="dripicons-power" /> <span>Logout</span>{" "}
                      </a>{" "}
                    </div>
                  </li>
                </ul>
              ...
              <div id="navigation">
                ...
                <ul className="navigation-menu">
                  <li className="has-submenu active">
                    {" "}
                    <a href="profile.html">
                      <i className="fi-air-play" />Profile
                    </a>{" "}
                  </li>
                  <li>
                    {" "}
                    <a href="agreement.html">
                      <i className="fi-paper" />Agreement
                    </a>{" "}
                  </li>
                  <li>
                    {" "}
                    <a href="my-property.html">
                      <i className="fi-box" />My Property
                    </a>{" "}
                  </li>
                  <li>
                    {" "}
                    <a href="service.html">
                      <i className="fi-tag " />Services
                    </a>{" "}
                  </li>
                  <li>
                    {" "}
                    <a href="payment.html">
                      <i className="fi-briefcase " />Payments
                    </a>{" "}
                  </li>
                  <li>
                    {" "}
                    <a href="" onClick={()=>{this.props.history.push('/tenantprofile')}}>
                      <i className="fi-head " />Agent
                    </a>{" "}
                  </li>
                  <li>
                    {" "}
                    <a href="" onClick={()=>{this.props.history.push('/tenantprofile')}}>
                      <i className="fi-head " />Tenant
                    </a>{" "}
                  </li>
                  <li>
                    {" "}
                    <a href="settings.html">
                      <i className="fi-cog " />Settings
                    </a>{" "}
                  </li>
                </ul>
                {/* End navigation menu */}
                    ...
                    <div className="row">
                      <div className="col-sm-3">
                        <div className="card-box widget-box-four">
                          ...
                          <div className="wigdet-four-content">
                            <h4
                              className="m-t-0 font-18 m-b-5"
                              title="Property"
                            >
                              Property
                            </h4>
                            <h3 className="m-b-0 m-t-35">
                              <span>10</span>{" "}
                              <span
                      ...
                      <div className="col-sm-3">
                        <div className="card-box widget-box-four">
                          ...
                          />
                          <div className="wigdet-four-content">
                            <h4 className="m-t-0 font-18 m-b-5" title="Agent">
                              Agent
                            </h4>
                            <h3 className="m-b-0 m-t-35">
                              <span>0</span>{" "}
                      ...
                      <div className="col-sm-3">
                        <div className="card-box widget-box-four">
                          ...
                          />
                          <div className="wigdet-four-content">
                            <h4 className="m-t-0 font-18 m-b-5" title="Tenant">
                              Tenant
                            </h4>
                            <h3 className="m-b-0 m-t-35">
                              <span>0</span>{" "}
            ...
            <div className="row">
              <div className="col-md-4">
                ...
                <div className="card-box">
                  <h4 className="header-title mt-0 m-b-20">
                    Personal Information
                  </h4>
                  <div className="panel-body">
                    <p className="text-muted font-13">
                      ...
                      create websites and mobile apps with great UX and UI
                      design. I have done work with big companies like Nokia,
                    ...
                    <div className="text-left">
                      <p className="text-muted font-13">
                        ...
                        <span className="m-l-15">Johnathan Deo</span>
                      </p>
                      <p className="text-muted font-13">
                        <strong>Mobile :</strong>
                        <span className="m-l-15">(+12) 123 1234 567</span>
                      </p>
                      <p className="text-muted font-13">
                        <strong>Email :</strong>{" "}
                        <span className="m-l-15">coderthemes@gmail.com</span>
                      </p>
                      <p className="text-muted font-13">
                    ...
                    <table className="table table-hover m-0 table-actions-bar">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <h5 className="m-b-0 m-t-0 font-600">Tomaslau</h5>
                          </td>
                          <td>
                            <i className="mdi mdi-map-marker text-primary" />{" "}
                            New York{" "}
                          </td>
                          <td>23/02/2018 </td>
                          <td>
              ...
              <div className="col-md-4">
                ...
                <div className="card-box">
                  ...
                  <div className="panel-body">
                    ...
                    <a className="btn btn-custom waves-light waves-effect w-md">
                      View
                    </a>{" "}
                  </div>
                </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-12 text-center">
                {" "}
                © 2018 Assets Watch. All Rights Reserved{" "}
              </div>
            </div>
          </div>
        </footer>
