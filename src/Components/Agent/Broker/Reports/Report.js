      ...
      <div className="row">
            <div className="col-md-4">
              <div className="card-box">
				  ...
				  <a className="btn btn-custom waves-light waves-effect w-md" href="broker-report-table?property">View</a>
              </div>
            </div>
            <div className="col-md-4">
              <div className="card-box">
				  ...
				  <a className="btn btn-custom waves-light waves-effect w-md" href="broker-report-table?Transaction">View</a>
              </div>
            </div>
            {/* <!-- end col --> */}
            ...
            <div className="col-md-4">
              <div className="card-box">
				  ...
				  <a className="btn btn-custom waves-light waves-effect w-md" href="broker-report-table?Contact">View</a>
              </div>
            </div>
            {/* <!-- end col -->  */}
          </div>
