...
export default class BrokerTenantProfile extends React.Component{
	render(){
		return(
            ...
            <div className="container">
              <div id="navigation"> 
                ...
                <ul className="navigation-menu">
                  ...
                  <li className="has-submenu active"> <a href="tenant.html"><i className="fi-head " />Tenant</a> </li>
            ...
            <div className="page-title-box">
              <div className="btn-group pull-right">
                <ol className="breadcrumb hide-phone p-0 m-0">
                  <li><a href="tenant.html" className="btn waves-light waves-effect w-md btn-custom"><i className="fi-reply" />&nbsp;&nbsp;Back</a></li>
                </ol>
              </div>
                    ...
                    <div className="row"> 
                      <div className="col-md-8">
                        ...
                        <div className="details-dec ">
                          ...
                          <p className="text-muted m-b-3 "><i className="icon-envelope" />&nbsp; tenant@info.com</p>
