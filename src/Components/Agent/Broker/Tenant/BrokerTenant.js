	...
	changeTabs(id) {
		if(id == "agent-request") {
            ...
            $("#joined").removeClass("active");
			 ...
			 $("#connTab").removeClass("active");
			 $("#loaderDiv").show();
			fetch(`${API_URL}assetsapi/invite_status/${JSON.parse(this.state.userData).assets_id}/3/${JSON.parse(this.state.userData).session_id}/`, {
			  method: 'get',
			})
			.then(res => res.json())
			.then(
            ...
            $("#joined").removeClass("active");
			 ...
			 $("#invitestatusTab").removeClass("active");
			 $("#loaderDiv").show();
			fetch(`${API_URL}assetsapi/connection_history/${JSON.parse(this.state.userData).assets_id}/3/${JSON.parse(this.state.userData).session_id}/`, {
			  method: 'get',
			})
			.then(res => res.json())
			.then(
            ...
            <div className="page-title-box">
              <div className="pull-right  my-proprty">
               <a href="#" data-toggle="modal" data-target="#send-email" className="btn waves-light waves-effect w-md btn-custom m-r-10"><i className="fi-open"></i>&nbsp;&nbsp;Send Email</a>
                <a href="#" data-toggle="modal" data-target="#send-invite" className="btn waves-light waves-effect w-md btn-custom"><i className="fi-open" />&nbsp;&nbsp;Send Invite</a>
