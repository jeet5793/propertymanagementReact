...
if (this.state.redirect){
	...
	return(
		<div>
			...
			<div id="background-verifi"  className="modal fade show in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style={{display: "none ! important"}}>
					  ...
					  <div className="col-md-12">
						...
						<div className="form-group">
						  <div className="row">
							...
							<div className="col-md-4">
							  <select className="form-control" name="gender" value={this.state.bgForm.gender || this.props.profileData.gender} onChange={this.onChangeBGVHandler}>
