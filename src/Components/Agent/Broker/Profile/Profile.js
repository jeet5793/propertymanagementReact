  ...
  //===================================recent tenant/agent==============================================================================
    ...
    render(){
      ...
      <div  style={{marginTop:'3%',marginBottom:'5%'}} className="wrapper">
        ...
        {/* Counter js  */} 
        {/* App js */} 
      </div>:<div className="container"  style={{marginTop:'20%',marginLeft:'40%',marginBottom:'25%'}}> <div className="row">
                <div className="col-sm-12"><img src="http://wordpress.templaza.net/real-estate/wp-content/themes/real-estate/images/loading_blue_64x64.gif"/></div></div></div>
