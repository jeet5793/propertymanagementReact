...
import $ from 'jquery';
class BrokerNotifications extends React.Component{
	constructor(props){
		super(props)
			...
			body: JSON.stringify(opts)
			  ...
			  if(data)
			  {
					$("#loaderDiv").hide();
					   ...
					   $("#actionType").val("Yes");
					   $("#hiddenURL").val("broker-notifications");
...
export default connect(state=>({ userData: state.userData, userProfile: state.userProfile }))(BrokerNotifications)