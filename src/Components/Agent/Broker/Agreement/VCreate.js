										...
										<div id="collapseThree" className="collapse" role="tabpanel" aria-labelledby="headingThree">
											<div className="card-block">
												<div className="add-name">
													...
													<input type="button" value="Primary Second Tenant Full Name" onClick={this.insertComponent.bind(this)} />
													<input type="button" value="Primary Third Tenant Full Name" onClick={this.insertComponent.bind(this)} />
