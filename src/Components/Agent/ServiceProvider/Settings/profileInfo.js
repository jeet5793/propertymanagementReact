...
class ProfileInfo extends React.Component{
	...
	profileSubmit(e)
	{
		...
		//console.log('settingOpts'+JSON.stringify(settingOpts));
	    $("#loaderDiv").show();
                      ...
                      <div className="col-sm-12">
                        <div className="page-title-box">
						  ...
						  <div className="btn-group pull-right" style={{marginBottom:"10px"}}>
							...
							<li>
							<Link to={'/agent-serviceprovider'}><span className="btn waves-light waves-effect w-md btn-custom"><i className="fi-reply"></i>&nbsp;&nbsp;Back</span></Link></li>
							</ol>
						</div>
                        </div>
                      </div>
