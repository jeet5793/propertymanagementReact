                ...
                <div className="topbar-main">
                    ...
                    <div className="logo"> 
                        ...
                        <div className="menu-extras topbar-custom">
						 ...
						 <li className="list-inline-item">{JSON.parse(this.state.userData).planName} plan {JSON.parse(this.state.userData).planName!='Basic'?`expire on  ${JSON.parse(this.state.userData).expireDate}`:''}</li>
