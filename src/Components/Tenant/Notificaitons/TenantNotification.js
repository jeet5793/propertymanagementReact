...
class TenantNotification extends React.Component {
   constructor(props){
    ...
    render(){
        ...
        return(
            <div>
				<Header name="tenant-notifications"  first_name={window.localStorage.getItem('firstName')} 
...
export default connect(state=>({ userData: state.userData, userProfile: state.userProfile }))(TenantNotification)