...
class TenantAgentProfile extends React.Component {
    render() {
        return (
            <div>
                {/* Navigation Bar*/}
                ...
                <div className="navbar-custom">
                    ...
                    <div id="navigation"> 
                        ...
                        <li className="has-submenu active"> <a href="agent.html"><i className="fi-head " />Agent</a> </li>
                ...
                <div className="container"> 
                    ...
                    <div className="btn-group pull-right">
                        ...
                        <li><a href="agent.html" className="btn waves-light waves-effect w-md btn-custom"><i className="fi-reply" />&nbsp;&nbsp;Back</a></li>
                        </ol>
                    </div>
                    ...
                    <div className="col-md-12 col-lg-12 second-profiles-details">
                        ...
                        <div className="col-md-12"> 
                            ...
                            <div className="col-md-8">
                                <span className="pull-left m-r-15"><img src="assets/images/users/avatar-1.jpg" alt className="second-profiles rounded-circle" /></span>
                                <div className="details-dec ">
                                <h4 className="m-t-5 m-b-5 font-18 ellipsis">Agent 01</h4>
                                <p className="font-13 m-b-3"> Agent Profile</p>
                                <p className="text-muted m-b-3"><i className="icon-phone" />&nbsp; 09999999999</p>
                                <p className="text-muted m-b-3 "><i className="icon-envelope" />&nbsp; agent@info.com</p>
                            ...
                            <div className="col-md-4">
                                ...
                                <a href="#" data-toggle="modal" data-target="#send-msg" className="btn waves-light waves-effect w-md btn-custom m-t-30	"><i className="fi-mail" />&nbsp;&nbsp;Send Message</a>
                            </div>	
                            </div>	
                        </div>	
                        <hr />
                ...
                <div className="modal-dialog">
                    ...
                    <div className="modal-body">
                        ...
                        <div className="col-md-12">
                            ...
                            <input type="text" className="form-control" placeholder defaultValue="Agent1" id="nme" />
                            </div>
                        </div>
                        </div>
                        <div className="row">
...
export default TenantAgentProfile;