					  ...
					  <div className="col-md-12">
						...
						<div className="form-group">
						  <div className="row">
							...
							<div className="col-md-4">
							  <input type="text" className="form-control" name="phone"  id="mobile-no" placeholder="" value={this.state.bgForm.phone || this.props.profileData.mobile_no}  onChange={this.onChangeBGVHandler} />
							</div>
							<div className="col-md-2">
