                   ...
                   <div className="col-sm-6 pay-now">
                     <div className="card-box widget-box-four">
                       <div className="card-body p-5">
                         ...
                         <form role="form" className="card-dtl" method ="post" >
                           <div className="form-group">
                             <label htmlFor="name">Full Name (Card)</label>
                             <input type="text" ref="name" className="form-control" name="name" placeholder  />
                           </div> {/* form-group.// */}
                           <div className="form-group">
                             <label htmlFor="cardNumber">Card Number</label>
                             <input type="text" ref="cardNumber" className="form-control" name="cardNumber"  placeholder />
                           </div> {/* form-group.// */}
                           <div className="row">
                             <div className="col-sm-8">
                               <div className="form-group">
                                 ...
                                 <div className="form-inline">
                                   <select className="form-control" style={{width: '45%'}} value='' >
                             ...
                             <div className="col-sm-4">
                               <div className="form-group">
                                 ...
                                 <input className="form-control" ref="cvv" name="cvv"  type="text" />
                               </div> {/* form-group.// */}
                             </div>
                           </div> {/* row.// */}
