                      ...
                      {this.state.shareholders.map((shareholder, idx) => {
                        ...
                        return <div>
                          <div className="form-group row">
                            ...
                            <div className="col-lg-10 col-md-9 col-sm-9">
                              <input type="text" value={this.state.shareholders[idx].owner_name} name={'owner_name' + (idx)} placeholder={`Owner #${idx + 2} owner_name`} className="form-control" onChange={(e) => { this.onChangeHandler(e, idx) }} />
                            </div>
                          </div>
                          {/*add second owner*/}
                          <div className="form-group row">
                            ...
                            <div className="col-lg-10 col-md-9 col-sm-9">
                              <input type="text" value={this.state.shareholders[idx].address} name={'address' + (idx)} placeholder={`Owner #${idx + 2} address1`} onChange={(e) => { this.onChangeHandler(e, idx) }} className="form-control" />
                          ...
                          <div className="form-group row">
                            <label className="col-lg-2 col-md-3 col-sm-3 col-form-label">Address2</label>
                            <div className="col-lg-10 col-md-9 col-sm-9">
                              <input type="text" value={this.state.shareholders[idx].address2} name={'address2' + (idx)} placeholder={`Owner #${idx + 2} address2`} onChange={(e) => { this.onChangeHandler(e, idx) }} className="form-control" />
                          ...
                          <div className="form-group row">
                            ...
                            <option value={this.state.shareholders[idx].state}>{this.state.shareholders[idx].state}</option>
                          ...
                          <div className="form-group row">
                            <label className="col-lg-2 col-md-3 col-sm-3 col-form-label required">City</label>
                            <div className="col-lg-4 col-md-9 col-sm-9 adpro-lbl">
                            <select value={this.state.shareholders[idx].city} className="form-control" id={'city' + (idx)} name={'city' + (idx)}  onChange={(e) => { this.onChangeHandler(e, idx) }} >

                            <option value={this.state.shareholders[idx].city}>{this.state.shareholders[idx].city}</option>
                          ...
                          <div className="form-group row">
                            ...
                            <div className="col-lg-4 col-md-9 col-sm-9 adpro-lbl">
                            <input type="text" value={this.state.shareholders[idx].mobile_no} className="form-control" name={'mobile_no' + (idx)} onChange={(e) => { this.onChangeHandler(e, idx) }} />
                            </div>
                            <label className="col-lg-2 col-md-3 col-sm-3 col-form-label required">Email</label>
                            <div className="col-lg-4 col-md-9 col-sm-9 adpro-lbl">
                              <input type="text" value={this.state.shareholders[idx].email} className="form-control" name={'email' + (idx)} onChange={(e) => { this.onChangeHandler(e, idx) }} />
                            </div>
                          </div>
                          <div className="form-group row">
