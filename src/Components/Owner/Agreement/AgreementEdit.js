...
export default class AgreementEdit extends React.Component{
  constructor(props){
    super(props)
  ...
  componentWillReceiveProps(nextProps) {
    // console.log('nextProps ', nextProps)
      if (nextProps.editAgreement) {
		  ...
		  tinymce.get("editor1").setContent(agreement.agreement_doc_content);
...
editAgreement(){
  ...
  if(agreementForm.agreement_title!==''&&agreementForm.agreement_doc_content!=='')
  {
    ...
    demoTemplate(item)
	  {
		   ...
		   console.log(item.templateDescription);
		  var tinymce=window.tinyMCE,$=window.$
		 tinymce.get("editor1").setContent(item.templateDescription);
    ...
    render(){
    {window.tinyMCE.get("editor1") && window.$('#previewDiv').html(window.tinyMCE.get("editor1").getContent())}
    return (
    <div className="tab-pane" id="v-edit" style={{display: 'none'}}>
		...
		<div className="form-group">
										  ...
										  <div id="accordion"  className="m-b-10">
											...
											<div className="card m-b-5">
											  <div className="card-header  btn btn-success waves-effect w-md waves-light" role="tab" id="headingOne">
												<h5 className="mb-0 mt-0"> <a className="font-blk" data-toggle="collapse" data-parent="#accordion" href="#collapseOne2" aria-expanded="false" aria-controls="collapseOne"> Header Section </a> </h5>
											  </div>
											  <div id="collapseOne2" className="collapse" role="tabpanel" aria-labelledby="headingOne">
											...
											<div className="card m-b-5">
											  <div className="card-header  btn btn-success waves-effect w-md waves-light" role="tab" id="headingTwo">
												<h5 className="mb-0 mt-0"> <a className="font-blk" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo2" aria-expanded="false" aria-controls="collapseTwo"> Footer Section </a> </h5>
											  </div>
											  <div id="collapseTwo2" className="collapse" role="tabpanel" aria-labelledby="headingTwo">
												<div className="card-block">
												  <div className="row">
													<div className="col-sm-12">
										   ...
										   <div className="card m-b-5">
											  <div className="card-header  btn btn-success waves-effect w-md waves-light" role="tab" id="headingThree">
												<h5 className="mb-0 mt-0"> <a className="font-blk" data-toggle="collapse" data-parent="#accordion" href="#collapseThree2" aria-expanded="false" aria-controls="collapseThree"> Agreement Template </a> </h5>
											  </div>
											...
											<div className="card m-b-5">
											  <div className="card-header btn btn-success waves-effect w-md waves-light" role="tab" id="headingFour">
												<h5 className="mb-0 mt-0"> <a className="font-blk" data-toggle="collapse" data-parent="#accordion" href="#collapseFour2" aria-expanded="false" aria-controls="collapseFour"> Insert Dynamic Value </a> </h5>
											  </div>
											  <div id="collapseFour2" className="collapse" role="tabpanel" aria-labelledby="headingFour">
												<div className="card-block">
												  <div className="add-name">
											...
											<div className="card">
											  <div className="card-header btn btn-success waves-effect w-md waves-light" role="tab" id="headingFive">
												<h5 className="mb-0 mt-0"> <a className="font-blk" data-toggle="collapse" data-parent="#accordion" href="#collapseFive2" aria-expanded="false" aria-controls="collapseFive"> Insert Components </a> </h5>
											  </div>
								  ...
								  <div className="row m-t-20">
									<div className="col-sm-12">
									 ...
									 <textarea name="agreement_doc_content" onChange={this.onChangeHandler} id="editor1" style={{position:'absolute',left:'0'}} className="tinymce"></textarea> 
									</div>									 
								  </div>
		...
		<div className="row">
									  <div className="col-sm-12" >
										...
										<div id="previewDiv" className="row m-t-20 signature  autohide-scroll" style={{height:"600px",width:"100%",
										padding: "12px"}}>
				...
				<button type="button" name="previous" className="previous button-back btn btn-default waves-effect pull-left" value="" >Back</button>
				<button type="submit" name="submit" className="btn btn-primary waves-effect waves-light submit pull-right" value="" >Submit</button>
		</fieldset>
		</form>
