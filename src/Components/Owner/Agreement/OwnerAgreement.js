                                        ...
                                        <div className="tabs-vertical-env">
                                            <div className="row">
                                                <div className="col-md-2">
                                                    <ul className="customNav tabs-vertical">
                                                        <li className="nav-item active"> <a href="#v-saved" className="nav-link agreement-fa" data-toggle="tab" aria-expanded="false"><i className="icon-folder-alt"></i>&nbsp;&nbsp;Saved</a> </li>
				...
				{/* =================Create==========================*/}
                          ...
                          <div className="row m-t-20">
							...
							{/* <!-- <textarea name="editor" id="editor" className="text"></textarea> -->*/}
							 ...
							 <textarea name="editor" id="editor" className="tinymce form-control"></textarea>
                                                            ...
                                                            <div className=" table-responsive">
                                                                <table className="table bdr">
                                                                    ...
                                                                    <tr>
                                                                        <td>Property Title Property Title Property Title</td>
                                                                        <td>10/05/2018</td>
                                                                        <td><a title="View"  className="table-action-btn view-rqu accordion-toggle" data-toggle="collapse" data-target="#collapseOne"><i className="mdi mdi-eye"></i></a><a title="Send" className="table-action-btn view-rqu" data-toggle="modal" data-target="#send-msg"><i className="mdi mdi-redo-variant"></i></a></td>
                                                                    </tr>
