                                        ...
                                        <div className="row">
                                            <div className="col-md-2">
                                                <ul className="nav tabs-vertical">
													<li className="nav-item" onClick={this.changeTabs.bind(this, "v-create")}> <a id="createTab" href="#v-create" className="nav-link" data-toggle="tab" aria-expanded="true" onClick={this.getSendedList}>Create</a> </li>
