      ...
      <div className="row">
            <div className="col-md-12">
              <div className="card-box">
				  ...
				  <Link className="btn btn-custom waves-light waves-effect w-md" to={"/owner-report-table?property"}>View</Link>
              </div>
            </div>
            <div className="col-md-12">
              <div className="card-box">
				  ...
				  <Link className="btn btn-custom waves-light waves-effect w-md" to={"/owner-report-table?Transaction"}>View</Link>
              </div>
            </div>
            {/* <!-- end col --> */}
